      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Click on any exercise to view details and add it to your custom
            workout plan
          </p>
        </div>
                      ...
                      <div className="flex items-center">
                        <span className="px-3 py-1 text-sm font-medium text-purple-800 bg-purple-100 rounded-full">
                          {selectedExercise.muscleGroup
                            .charAt(0)
                            .toUpperCase() +
                            selectedExercise.muscleGroup.slice(1)}
                        </span>
      ...
      <div className="flex flex-row sm:flex-row md:flex-col">
        ...
        <div className="flex-1 p-4">
          <div className="flex flex-col justify-between items-start mb-2 sm:flex-row md:flex-col">
            <h3 className="text-lg font-semibold text-gray-900 transition-colors group-hover:text-purple-600 line-clamp-1">
              {exercise.name}
            </h3>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs font-medium text-purple-500 group-hover:underline">
              View details
            </span>
          </div>
        </div>
