  ...
  const features = [
    {
      ...
      description: "Log and monitor your exercises with ease",
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Health Metrics",
      description: "Track vital statistics and progress",
    },
    {
  ...
  const testimonials = [
    {
      ...
      quote:
        "ABLIFT has transformed my fitness journey. I love how easy it is to track my workouts and stay motivated!",
      rating: 5,
    },
    {
      name: "Sarah M.",
      ...
      quote:
        "The best fitness tracking app I've ever used. My clients love the intuitive interface!",
      rating: 5,
    },
    {
      name: "John D.",
      role: "Gym Owner",
      quote:
        "ABLIFT has helped my gym members stay consistent and achieve their goals faster.",
      rating: 4,
    },
    {
      name: "Emily R.",
      ...
      quote:
        "The app's scheduling feature is a game-changer for my yoga classes.",
      rating: 5,
    },
  ];
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-12 max-w-3xl mx-auto">
            Your ultimate fitness companion for tracking workouts, managing
            nutrition, and achieving your fitness goals.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="p-6 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-1"
              >
