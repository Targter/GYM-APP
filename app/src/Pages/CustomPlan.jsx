      ...
      <div className="container px-4 py-4 mx-auto sm:py-8">
        ...
        >
          ...
          <p className="text-sm text-gray-600 sm:text-base">
            Design your own workout routine with exercises from our library
          </p>
        </motion.div>
        ...
        <div className="p-4 mb-6 bg-white rounded-xl shadow-md sm:p-6 sm:mb-8">
          ...
          <div className="flex flex-col justify-between items-start mb-4 sm:flex-row sm:items-center">
            <h2 className="mb-2 text-lg font-semibold text-gray-800 sm:mb-0 sm:text-xl">
              Workout Days
            </h2>
            <button
              onClick={addDay}
            ...
            <div className="flex flex-col justify-between items-start mb-4 sm:flex-row sm:items-center">
              <div className="flex items-center mb-2 w-full sm:mb-0 sm:w-auto">
                ...
                <span className="ml-2 text-sm text-gray-500 sm:text-base">
                  ({days[activeDay].exercises.length} exercises)
                </span>
              </div>
              <button
              ...
              <div className="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2 lg:grid-cols-3">
                {filteredExercises.map((exercise) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-600 line-clamp-2 sm:text-sm">
