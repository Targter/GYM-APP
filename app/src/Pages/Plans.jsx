...
const Plans = () => {
  ...
  const planDetails = {
    classic: {
      image:
        "https://i.pinimg.com/474x/53/ec/b5/53ecb5dae265e12b423ed8cdbdb1de03.jpg",
      title: "Classic Body Part Split",
      days: "5 Days per Week",
      description:
        "Traditional bodybuilding split targeting each muscle group once per week",
      intensity: "High",
      experience: "Intermediate",
    },
    ppl: {
      image:
        "https://i.pinimg.com/474x/81/3a/a7/813aa7255685f11be23fd13de9ac84b2.jpg",
      title: "Push, Pull, Legs",
      days: "6 Days per Week",
      description:
        "Efficient split for maximum muscle growth and strength gains",
      intensity: "High",
      experience: "Advanced",
    },
    "upper-lower": {
      image:
        "https://i.pinimg.com/474x/45/40/c1/4540c1ae44d7ec684bac54292b99bdc5.jpg",
    ...
    fullbody: {
      image:
        "https://i.pinimg.com/474x/d0/ca/72/d0ca72fac05f6b51c4e888ba0c154381.jpg",
      title: "Full-Body Routine",
      days: "3 Days per Week",
      description:
        "Perfect for beginners and those with limited time for exercise, this routine offers a simple yet effective way to stay active.",
      intensity: "Moderate",
      experience: "Beginner",
    },
    power: {
      image:
        "https://i.pinimg.com/736x/b2/15/63/b21563f95b6b34fce85bc843699038f5.jpg",
      title: "Power & Hypertrophy Split",
      days: "5 Days per Week",
      description:
        "Focus on building strength and increasing muscle size through a well-structured workout plan that incorporates progressive overload.",
      intensity: "Very High",
      experience: "Advanced",
    },
    endurance: {
      image:
        "https://i.pinimg.com/474x/cb/5d/ee/cb5deee7a729b262409de28df8392fa4.jpg",
      title: "Endurance Training",
      days: "4 Days per Week",
      description:
        "Improve stamina and functional fitness along with muscle tone and endurance. This plan is perfect for those looking to increase cardiovascular health.",
      intensity: "Moderate",
    ...
    switch (plan) {
      case "classic":
        selectedExercises = {
          ...
          day4: [
            ...exercises.shoulders.slice(0, 4),
            ...exercises.core.slice(0, 3),
          ], // Shoulders & Core
